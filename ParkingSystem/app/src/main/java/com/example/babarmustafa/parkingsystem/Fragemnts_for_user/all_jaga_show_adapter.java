 ...
 */
//
//public class all_jaga_show_adapter {
//}
...
public class  all_jaga_show_adapter extends BaseAdapter {
    ...
    public  all_jaga_show_adapter(ArrayList< USer_POsition> dataList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.jaga_single, null);


        TextView forname = (TextView) view.findViewById(R.id.fee);
