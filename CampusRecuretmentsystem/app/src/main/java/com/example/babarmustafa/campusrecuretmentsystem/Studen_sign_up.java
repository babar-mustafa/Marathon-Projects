 ...
 */
public class Studen_sign_up extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
            ...
            View view = inflater.inflate(R.layout.fragment_studen_sign_up, container, false);
                        ...
                        .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    user = new Student_info(id, get_name_of_student, get_email_of_student, get_pass_of_student,to_get_gender);
                                    ...
                                    databse.child("Student_info").child(user.getUID()).setValue(hashObj);
                                    databse.child("Admin-Panel").child("Student_info_for_admin").child(user.getUID()).setValue(hashObj);
                                    progres.dismiss();
                                    //to close activity
