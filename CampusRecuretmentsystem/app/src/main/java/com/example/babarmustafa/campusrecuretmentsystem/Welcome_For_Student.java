...
public class Welcome_For_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_welcome__for__student);
        Tab2566 = new ComponyNAme_to_Students();
        Tab002597 = new Jobs();


        mTabLayout = (TabLayout) findViewById(R.id.tab_layout_to_s);
        mViewPager = (ViewPager) findViewById(R.id.view_pager_to_s);
        ...
        */
        ...
        mTabLayout.addTab(mTabLayout.newTab().setText("Compony Names"));
        mTabLayout.addTab(mTabLayout.newTab().setText("Jobs Available"));
